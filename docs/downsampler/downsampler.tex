...
\begin{abstract}
    A downsampling method for stress-strain data that uses few points to preserve curvature within a pre-defined tolerance is proposed in this document.
    This method is built on existing downsampling algorithms originally developed for cartographic applications.
    The proposed method is extended to preserve the difference in energy between the original and downsampled data.
...
A better downsampling procedure was proposed consisting of two main steps and two auxiliary steps.
